        ...
        <q-list bordered padding>
            <q-item>
                <q-item-section>
                    ...
                    <q-btn icon="edit" push @click="edit">
                        Edit
                    </q-btn>
                    <div>
                        <q-item v-for="(value, name) in $auth.user" :key="name">
                            <q-item-section>
                                <q-item-label>
                                    {{name}} :
                                </q-item-label>
                            ...
                            <q-item-section>
                                <q-input  v-model="text" :label="value" :readonly='editable' />
                            </q-item-section>
                        </q-item>
                        <q-btn label="Save changes" @click="save" />
                    </div>
                </q-item-section>
            </q-item>
            <q-separator spaced />
